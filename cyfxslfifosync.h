 ...
 */
#define CY_FX_SLFIFO_GPIF_16_32BIT_CONF_SELECT (0)             /* use 16 bit wide parallel data bus*/
#define CY_FX_SLFIFO_DMA_BUF_COUNT      (2)                    /* bulk buffer count */
...
#define CY_FX_SLFIFO_THREAD_STACK       (0x0800)              /* application thread stack size */
#define CY_FX_SLFIFO_THREAD_PRIORITY    (8)                   /* application thread priority */
#define DebugPrint  CyU3PDebugPrint

/************************************endpoint and socket*****************************************/
/* To change the Producer and Consumer EP enter the appropriate EP numbers for the #defines.
 * In the case of IN endpoints enter EP number along with the direction bit.
 * For eg. EP 1 IN endpoint is 0x81
 *     and EP 1 OUT endpoint is 0x01.
...
#define CY_FX_PRODUCER_USB_SOCKET    CY_U3P_UIB_SOCKET_PROD_1    /* This socket is automatically mapped to EP 1 out */
#define CY_FX_CONSUMER_USB_SOCKET    CY_U3P_UIB_SOCKET_CONS_1    /* This socket is automatically mapped to EP 1 in */

/* Used with FX3 Silicon. */
#define CY_FX_PRODUCER_PPORT_SOCKET    CY_U3P_PIB_SOCKET_0    /* P-port Socket 0 is producer to stream data from external FPGA */
#define CY_FX_CONSUMER_PPORT_SOCKET    CY_U3P_PIB_SOCKET_3    /* P-port Socket 3 is consumer to stream data to external FPGA*/
